...
final class ScrapeBlueprint
{
    ...
    public function __construct(
        ...
        public readonly ImageResizeConfig $imageResize = new ImageResizeConfig(),
        public readonly WatermarkConfig $watermark = new WatermarkConfig(),
    ...
    public static function fromArray(array $data): self
    {
        return new self(
            ...
            imageFolder:     isset($data['image_folder']) && $data['image_folder'] !== null && $data['image_folder'] !== ''
                                 ...
                                 : null,
            imageResize:     ImageResizeConfig::fromArray($data['image_resize'] ?? []),
            watermark:       WatermarkConfig::fromArray($data['watermark'] ?? []),
            ...
            filters:        FiltersConfig::fromArray($data['filters'] ?? []),
    ...
    public function toArray(): array
    {
        return [
            ...
            'image_resize'      => $this->imageResize->toArray(),
